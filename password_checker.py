...
def verificar_senha(senha: str) -> dict:
   ...
   if len(senha) >= 8:
      score += 1
      criterios["compriment_minimo"] = True
   else: 
      criteiros["comprimento_minimo"] = False
      feedbakcs.append("❌senha muito curt. Use pelo menos 8 caracteres.")
